...
#ifndef _INTERGEN_GENERATED__physics_H_
#define _INTERGEN_GENERATED__physics_H_
...
public:
    ...
    float get_angular_factor( const btRigidBody* obj );

    void set_angular_factor( btRigidBody* obj, float factor );
    ...
    void remove_collision_object_external( btCollisionObject* obj );
    ...
    btTriangleMesh* create_triangle_mesh();

    void destroy_triangle_mesh( btTriangleMesh* triangle_mesh );

    void add_triangle( btTriangleMesh* mesh, const float v0[3], const float v1[3], const float v2[3] );

    btCollisionShape* create_shape( bt::EShape sh, const float hvec[3], void* data = nullptr );
...
public:
    ...
    static const int HASHID = 2909511262u;
    ...
    static const coid::token& intergen_default_creator_static( backend bck ) {
        static const coid::token _dc("bt::physics.get@2909511262"_T);
...
inline iref<T> physics::create( T* _subclass_, double r, void* context, coid::taskmaster* tm )
{
    ...
    static const coid::token ifckey = "bt::physics.create@2909511262"_T;
    ...
    if (!create) {
        log_mismatch("create"_T, "bt::physics.create"_T, "@2909511262"_T);
        return 0;
    }
...
inline iref<T> physics::get( T* _subclass_ )
{
    ...
    static fn_creator create = 0;
    static const coid::token ifckey = "bt::physics.get@2909511262"_T;
    ...
    if (!create) {
        log_mismatch("get"_T, "bt::physics.get"_T, "@2909511262"_T);
        return 0;
    }
...
inline float physics::get_angular_factor( const btRigidBody* obj )
{ return VT_CALL(float,(const btRigidBody*),18)(obj); }

inline void physics::set_angular_factor( btRigidBody* obj, float factor )
{ return VT_CALL(void,(btRigidBody*,float),19)(obj,factor); }

inline btCollisionObject* physics::create_collision_object( btCollisionShape* shape, void* usr1, void* usr2 )
{ return VT_CALL(btCollisionObject*,(btCollisionShape*,void*,void*),20)(shape,usr1,usr2); }

inline btGhostObject* physics::create_ghost_object( btCollisionShape* shape, void* usr1, void* usr2 )
{ return VT_CALL(btGhostObject*,(btCollisionShape*,void*,void*),21)(shape,usr1,usr2); }
...
{ return VT_CALL(void,(btGhostObject*&),23)(obj); }

inline void physics::update_collision_object( btCollisionObject* obj, const btTransform& tr, bool update_aabb )
{ return VT_CALL(void,(btCollisionObject*,const btTransform&,bool),24)(obj,tr,update_aabb); }

inline void physics::set_collision_info( btCollisionObject* obj, unsigned int group, unsigned int mask )
{ return VT_CALL(void,(btCollisionObject*,unsigned int,unsigned int),25)(obj,group,mask); }

inline bool physics::add_collision_object( btCollisionObject* obj, unsigned int group, unsigned int mask, bool inactive )
{ return VT_CALL(bool,(btCollisionObject*,unsigned int,unsigned int,bool),26)(obj,group,mask,inactive); }

inline void physics::remove_collision_object( btCollisionObject* obj )
{ return VT_CALL(void,(btCollisionObject*),27)(obj); }

inline void physics::remove_collision_object_external( btCollisionObject* obj )
{ return VT_CALL(void,(btCollisionObject*),28)(obj); }

inline int physics::get_collision_flags( const btCollisionObject* co )
{ return VT_CALL(int,(const btCollisionObject*),29)(co); }

inline void physics::set_collision_flags( btCollisionObject* co, int flags )
{ return VT_CALL(void,(btCollisionObject*,int),30)(co,flags); }

inline btCompoundShape* physics::create_compound_shape()
{ return VT_CALL(btCompoundShape*,(),31)(); }

inline void physics::add_child_shape( btCompoundShape* group, btCollisionShape* child, const btTransform& tr )
{ return VT_CALL(void,(btCompoundShape*,btCollisionShape*,const btTransform&),32)(group,child,tr); }

inline void physics::remove_child_shape( btCompoundShape* group, btCollisionShape* child )
{ return VT_CALL(void,(btCompoundShape*,btCollisionShape*),33)(group,child); }

inline void physics::update_child( btCompoundShape* group, btCollisionShape* child, const btTransform& tr )
{ return VT_CALL(void,(btCompoundShape*,btCollisionShape*,const btTransform&),34)(group,child,tr); }

inline void physics::get_child_transform( btCompoundShape* group, btCollisionShape* child, btTransform& tr )
{ return VT_CALL(void,(btCompoundShape*,btCollisionShape*,btTransform&),35)(group,child,tr); }

inline void physics::recalc_compound_shape( btCompoundShape* shape )
{ return VT_CALL(void,(btCompoundShape*),36)(shape); }

inline void physics::destroy_compound_shape( btCompoundShape*& shape )
{ return VT_CALL(void,(btCompoundShape*&),37)(shape); }

inline btTriangleMesh* physics::create_triangle_mesh()
{ return VT_CALL(btTriangleMesh*,(),38)(); }

inline void physics::destroy_triangle_mesh( btTriangleMesh* triangle_mesh )
{ return VT_CALL(void,(btTriangleMesh*),39)(triangle_mesh); }

inline void physics::add_triangle( btTriangleMesh* mesh, const float v0[3], const float v1[3], const float v2[3] )
{ return VT_CALL(void,(btTriangleMesh*,const float[3],const float[3],const float[3]),40)(mesh,v0,v1,v2); }

inline btCollisionShape* physics::create_shape( bt::EShape sh, const float hvec[3], void* data )
{ return VT_CALL(btCollisionShape*,(bt::EShape,const float[3],void*),41)(sh,hvec,data); }

inline btCollisionShape* physics::clone_shape( const btCollisionShape* shape )
{ return VT_CALL(btCollisionShape*,(const btCollisionShape*),42)(shape); }

inline void physics::add_convex_point( btCollisionShape* shape, const float point[3] )
{ return VT_CALL(void,(btCollisionShape*,const float[3]),43)(shape,point); }

inline void physics::close_convex_shape( btCollisionShape* shape )
{ return VT_CALL(void,(btCollisionShape*),44)(shape); }

inline void physics::destroy_shape( btCollisionShape*& shape )
{ return VT_CALL(void,(btCollisionShape*&),45)(shape); }

inline void physics::set_collision_shape_local_scaling( btCollisionShape* shape, const float3& scale )
{ return VT_CALL(void,(btCollisionShape*,const float3&),46)(shape,scale); }

inline bt::ot_world_physics_stats physics::get_stats()
{ return VT_CALL(bt::ot_world_physics_stats,(),47)(); }

inline bt::ot_world_physics_stats* physics::get_stats_ptr()
{ return VT_CALL(bt::ot_world_physics_stats*,(),48)(); }

inline void physics::set_debug_draw_enabled( btIDebugDraw* debug_drawer )
{ return VT_CALL(void,(btIDebugDraw*),49)(debug_drawer); }

inline void physics::set_debug_drawer_mode( int debug_mode )
{ return VT_CALL(void,(int),50)(debug_mode); }
...
{ return VT_CALL(void,(const double3&,float,coid::dynarray<btCollisionObject*>&),52)(pos,rad,result); }
...
{ return VT_CALL(void,(const double3&,const float4*,uint8,bool,coid::dynarray<btCollisionObject *>&),53)(pos,f_planes_norms,nplanes,include_partial,result); }

inline void physics::wake_up_objects_in_radius( const double3& pos, float rad )
{ return VT_CALL(void,(const double3&,float),54)(pos,rad); }

inline void physics::wake_up_object( btCollisionObject* obj )
{ return VT_CALL(void,(btCollisionObject*),55)(obj); }

inline bool physics::is_point_inside_terrain_ocluder( const double3& pt )
{ return VT_CALL(bool,(const double3&),56)(pt); }

inline void physics::pause_simulation( bool pause )
{ return VT_CALL(void,(bool),57)(pause); }
...
{ return VT_CALL(btTypedConstraint*,(btDynamicsWorld*,btRigidBody*,const btVector3&,btRigidBody*,const btVector3&,bool),58)(world,rb_a,pivot_a,rb_b,pivot_b,disable_collision); }

inline void physics::remove_constraint( btDynamicsWorld* world, btTypedConstraint* constraint )
{ return VT_CALL(void,(btDynamicsWorld*,btTypedConstraint*),59)(world,constraint); }

#pragma warning(pop)

} //namespace

#endif //_INTERGEN_GENERATED__physics_H_
